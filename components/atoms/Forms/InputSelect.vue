<template>
        <label ><input type="radio" name="my-radio"><span><slot /></span></label>
</template>

<style lang="scss" scoped>
@import "~assets/scss/style.scss";

.form-campaign-date span {
  position: relative;
  display: flex;
  align-items: center;
...
.form-campaign-date input[type="radio"]:checked + span {
  background-color: $color-main;
  color: $color-base;
}

.form-campaign-date input[type="radio"] {
  display: none;
}

.form-campaign-date input[type="radio"] + span::before {
  position: absolute;
  content: '';
  top: 50%;
  left: vw-sp(50);
...
.form-campaign-date input[type="radio"]:checked + span::after {
  position: absolute;
  content: '';
  top: 50%;
  left: vw-sp(50);
